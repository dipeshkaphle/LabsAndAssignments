...
import com.example.Lab8.utils.LocalDataBaseAdapter;
import com.example.Lab8.utils.LocalResponse;
...
public class LocalFragment extends Fragment {
    ...
    private void setData() {
        ...
        ArrayList<LocalResponse> singleRowArrayList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            LocalResponse singleRow = new LocalResponse(image, uid);
