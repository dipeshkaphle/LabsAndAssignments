...
int main() {
  ...
  for (int size : {800, 1600, 3200, 6400, 12800, 25600, 51200, 102400}) {
    ...
    time_elapsed = timeMyFunction(std::ranges::sort, reverseSorteda3);
    ...
    //
    // Best case
    // I'll just use the arrays from
    // last sort, as they'll be sorted
    // and  hence it should be best case
    time_elapsed = timeMyFunction(mergesort, randomArrA, l, size);
